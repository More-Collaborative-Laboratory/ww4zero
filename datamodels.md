...
-  `address`: The client's address
   -  Attribute type: **Property**. [address](https://schema.org/address)
   -  Required
-  `adressDelivery`: The delivery address
   -  Attribute type: **Property**. 
   -  Optional
-  `email`: Contact email address
   -  Attribute type: **Property**. [email](https://schema.org/email)
...
-  `endTime`: Date and hour on wich the assembly ends
   -  Attribute type: **Property**. 
   -  Optional
-  `assemblyStatus`: Indicates the status of the project's assembly * `0` - em producao * `1` - em espera para iniciar * `2` - em testes * `3` - testado e embalado. One of : `0`, `1`, `2`, `3`.
   -  Attribute type: **Property**. 
   -  Optional
-  `belongsTo`: Identification of the projet to which this assembly corresponds
   -  Attribute type: **Relationship**. 
